...
import com.sdsa.pardusmuzik.MainApp;
import com.sdsa.pardusmuzik.model.Track;
...
import com.sdsa.pardusmuzik.util.TrackUtil;
...
public class PlayerController {
    ...
    private void handleCredits() {
        ...
        alert.setTitle("Pardus Müzik Hakkında");
        alert.setHeaderText(null);
        alert.setContentText("Türk Yazılım Ekib üyesi Berk Can tarafından Pardus'e geliştirilmiştir.Emeği geçen herkese teşekkürlerimizi sunarız.");
        alert.showAndWait();
    }
